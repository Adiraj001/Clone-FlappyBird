...
class Pipe:
    def __init__(self, scale_factor, move_speed):
        self.img_up = pg.transform.scale(pg.image.load("assets/pipeup.png").convert_alpha(), (int(52 * scale_factor), int(320 * scale_factor)))
        self.img_down = pg.transform.scale(pg.image.load("assets/pipedown.png").convert_alpha(), (int(52 * scale_factor), int(320 * scale_factor)))
